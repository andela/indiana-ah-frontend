...
const DislikeSvg = color => (
 ...
 xmlSpace='preserve' width='4rem' height='4rem' className= 'icon-height icon_margin'>
 <g><g>
  <path
    fill = {color}
    d = {'M202,469.2c13.6,10,29.5,12.7,42.9,12.7c15.6,0,27.7-3.7,28.6-4c5.1-1.6,8.6-6.3,'
