...
const userFollowSpan = ({
  userDetails: { username, imageUrl }, followOrUnfollow: followUnFollowFunc, visible
}) => (
  <Fragment>
<div className="col-lg-3 bg-suc mb-5 p-3" onClick={UnfollowUser.bind(this, username, followUnFollowFunc)}>
...
<img src= {imageUrl} alt="John Doe" className=" img-fluid mr-3 user-follow-img"/>
</div>
</div>
  </div>
...
export default connect(null, { followOrUnfollow })(userFollowSpan);
