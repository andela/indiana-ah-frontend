...
class PersonalisedViewComponent extends Component {
  state = {
    ...
    featuredArticle: [
      ...
      {
        img: 'https://images.unsplash.com/photo-1521716250348-c4ae4ff1df43?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2682&q=80',
        title: 'lkjhljugyghjh',
        text: 'If you are going to use a passage of Lorem Ipsum, you need to be sure there isnt anything embarrassing hidden in the middle of text.',
        likeCount: 2,
        dislikeCount: 2,
      ...
      {
        img: 'https://images.unsplash.com/photo-1512808832507-c75aec26ebed?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=668&q=80',
        title: 'lkjhljugyghjh',
        text: 'If you are going to use a passage of Lorem Ipsum, you need to be sure there isnt anything embarrassing hidden in the middle of text.',
        likeCount: 2,
        dislikeCount: 2,
  ...
  render() {
    const { mostLikedArticle, featuredArticle } = this.state;
...
{mostLikedArticle.map((eachCard, index) => <CardComponent
  key= {index}
  img={eachCard.img}
...
export default PersonalisedViewComponent;
